...
export function iconButtonClassName({
  ...
  return cx(
    "pc-halo-icon pc-focus-ring pc-motion-safe inline-flex shrink-0 cursor-pointer items-center justify-center border border-[var(--pc-color-border)] bg-[var(--pc-color-surface)] text-[var(--pc-color-text)] shadow-[var(--pc-shadow-level-1)] transition-[background-color,border-color,box-shadow,transform] duration-[var(--pc-motion-fast)] ease-[var(--pc-ease-standard)] hover:bg-[var(--pc-color-surface-subtle)] active:translate-y-px disabled:cursor-not-allowed disabled:opacity-50",
    size === "compact"
